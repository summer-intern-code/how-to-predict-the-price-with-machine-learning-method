# -*- coding: utf-8 -*-
"""
Created on Thu May 31 15:04:41 2018
...
pre,real,last,theta=linearregression('D:/dataset/LTCBTC_15T.csv',22900,5000,1000,20)
csvFile2 = open('LTCBTC-14-22900,5000,1000,20.csv','w', newline='') # 设置newline，否则两行之间会空一行
...
for i in range(m):
    ...
    writer.writerow([pre[i],real[i],last[i],theta[i]])
